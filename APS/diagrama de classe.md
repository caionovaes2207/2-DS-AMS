...
<p>Afigura a seguirreproduz fielmente o diagrama construído no Astah, Convenção de notação: losango preenchido = composição; losango vazio = agregação; triângulo
...
4.6 Classes de associação: itemPrescricao e solicitacaoExame
